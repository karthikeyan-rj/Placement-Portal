...
export default function FeatureCard({ icon, title, description }: FeatureCardProps) {
  return (
    <div className="group bg-white rounded-[14px] border border-neutral-200/60 p-6 shadow-card transition-all duration-300 hover:shadow-raised hover:-translate-y-0.5 hover:border-primary-200/60">
      <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-[10px] bg-primary-50 text-primary-500 transition-all duration-300 group-hover:bg-primary-500 group-hover:text-white group-hover:shadow-soft">
        {icon}
      </div>
